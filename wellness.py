    ...
    st.markdown(
        flatten_html(
            ...
            <div style="text-align:center;padding:18px 10px 6px;">
                <div class="emocare-contact-row" style="display:flex;flex-wrap:wrap;
                            justify-content:center;align-items:center;gap:26px;margin-bottom:16px;">

                    <a href="mailto:soumyabhate19@gmail.com"
                       style="display:flex;align-items:center;gap:7px;
                              color:#F9E7B2;text-decoration:none;font-size:14px;">
                        <svg class="emocare-contact-icon" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <span class="emocare-contact-label">soumyabhate19@gmail.com</span>
                    </a>

                    <a href="https://linkedin.com/in/soumyabhate19" target="_blank" rel="noopener noreferrer"
                       style="display:flex;align-items:center;gap:7px;
                              color:#F9E7B2;text-decoration:none;font-size:14px;">
                        <svg class="emocare-contact-icon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                        ...
                        <span class="emocare-contact-label">soumyabhate19</span>
                    </a>
